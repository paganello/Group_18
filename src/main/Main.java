		...
		do {
			switch (stato) {
				...
				case turnStart:
					...
					listaPlayer.get(0).getShelf().getBox(1, 0).getTile().setColor(2);
					...
					listaPlayer.get(0).getShelf().getBox(1, 1).getTile().setColor(4);
					...
					listaPlayer.get(0).getShelf().getBox(0, 3).getTile().setColor(1);
					listaPlayer.get(0).getShelf().getBox(1, 3).getTile().setColor(1);
					...
					listaPlayer.get(0).getShelf().getBox(0, 4).getTile().setColor(1);
					listaPlayer.get(0).getShelf().getBox(1, 4).getTile().setColor(2);
					...
					listaPlayer.get(0).getShelf().getBox(0, 2).getTile().setColor(1);
					listaPlayer.get(0).getShelf().getBox(1, 2).getTile().setColor(2);
